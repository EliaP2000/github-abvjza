...
var nplatea = (document.getElementById('platea') as HTMLElement);
var npalchi = (document.getElementById('palchi') as HTMLElement);
...
class ordinePrenotazione { //per eliminare il problema della ripetizione delle strutture
  ...
  constructor(posti: any[][], elementName: HTMLElement) { /*Il costruttore prende come parametri: l'array con i posti già prenotati e il nome dell'elemento HTML che ospita i bottoni
